...
local keys = {"item", "tool", "ammo", "repair-tool"}
local pres = {"", "bob-"}
...
data:extend({
  {
    ...
    name = "starship",
    order = "f",
    icon = "__base__/graphics/item-group.png",
    icon_size = 64,
  },
  {
    type = "item-subgroup",
...
createAndRegisterItemAndRecipe("hull-panel", 1, {"low-density-structure", 20, "steel-plate", 10, "small-lamp", 5})
createAndRegisterItemAndRecipe("scaffolding", 1, {"low-density-structure", 10, "steel-plate", 4})
createAndRegisterItemAndRecipe("window", 0.5, {getIngredientWithFallback("glass", "plastic-bar"), 10})
...
createAndRegisterItemAndRecipe("power-storage-unit", 2, {"power-conduit", 5, getMaxTierOf("accumulator"), 20, "advanced-circuit", 10, "hull-panel", 1})
...
createAndRegisterItemAndRecipe("maintenance-bay", 30, {"repair-pack", 10000, "hull-panel", 8, getMaxTierOf("assembling-machine"), 4, getMaxTierOf("roboport"), 4, "body-segment", 1, getMaxTierOf("construction-robot"), 200})
createAndRegisterItemAndRecipe("cargo-bay", 30, {"electric-engine-unit", 8, "body-segment", 4, getIngredientWithFallback("angel-warehouse", "steel-chest", 1, 24), getMaxTierOf("logistic-robot"), 100})
createAndRegisterItemAndRecipe("habitation-rotator", 90, {"body-segment", 5, "electric-engine-unit", 80, "scaffolding", 20})
createAndRegisterItemAndRecipe("drydock-component", 90, {getMaxTierOf("construction-robot"), 250, getIngredientWithFallback("angel-warehouse", "steel-chest", 2, 50), "hull-panel", 5})
...
createAndRegisterItemAndRecipe("habitation-module", 120, {"habitation-section", 15, "habitation-rotator", 1, "scaffolding", 4, "power-conduit", 1})